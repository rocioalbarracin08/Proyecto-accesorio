...
def crearCategoria():
    ...
    if not nombreCategoria or not nombreCategoria.strip(): #No hay nada en la variable o si es válida con s
        return jsonify({"error": "La categoría no puede estar vacía"}), 400
